...
namespace Tsp
{
    ...
    public class Tour : List<Link>
    {
        ...
        /// "tour" - The incomplete child tour.
        /// "cityList" - The list of cities in this tour.
        /// "cityUsage" - Array that contains the number of times each city has been linked.
        /// <param name="city1">The first city in the link.
        /// <param name="city2">The second city in the link.
